  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <button
        ...
        className="flex w-full justify-center rounded-xl bg-brand-700 px-4 py-3 text-sm font-semibold text-white hover:focus-visible:outline-brand-700 disabled:opacity-70 transition-all active:scale-[0.98]"
      >
        {isPending ? (
          <>
